...
import { addToCart, fetchCartItems } from "@/store/shop/carts-slice";
import {
  fetchAllFiltersProducts,
  fetchProductDetail,
...
const ShoppingListing = () => {
  ...
  const handleFilter = (getSectionId, getCurrentOption) => {
    ...
    console.log(Object.keys(cpyFilters));
  ...
  const handleProductDetails = (currentProductId) => {
    dispatch(fetchProductDetail(currentProductId));
  };
  ...
  useEffect(() => {
    if (filters !== null && sort !== null)
      dispatch(
        fetchAllFiltersProducts({ filterParams: filters, sortParams: sort })
      );
